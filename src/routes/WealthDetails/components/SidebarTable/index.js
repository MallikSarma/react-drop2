...
import * as css from "./SidebarTable.scss";
import classnames from "classnames";
import { injectIntl, intlShape } from "react-intl";
import { Table } from "reactabular";

export const SidebarTable = ({intl,loans,data,getRender,tableHeader,tableFooter,cols, tableContainerClass}) => {
...
export default injectIntl(SidebarTable);
